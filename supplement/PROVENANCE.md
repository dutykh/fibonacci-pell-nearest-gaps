...
| `certificates/check_candidate_window_density_curator.py` | `scripts/check_candidate_window_density_curator.py` | `b9be80fbd4ad2645582d0422c3cf339594f73ea462a9f88b6c83c03410d28f2b` |
| `certificates/check_two_sign_odd_pell_orbit_independent_audit_agent_tsa.py` | `scripts/check_two_sign_odd_pell_orbit_independent_audit_agent_tsa.py` | `31d203a8debc02765cf658f98ed99f6d40061402b1f22ef08512f83416e8c2c4` |
| `certificates/check_even_pell_anchor_orbits_agent_epa.py` | `scripts/check_even_pell_anchor_orbits_agent_epa.py` | `94d4ce3dbbe27fa621a1cd9e2499eb67499cea4c803b8d38fbbc74ffda25edc1` |
| `certificates/check_even_pell_anchor_orbits_independent_audit_agent_eaa.py` | `scripts/check_even_pell_anchor_orbits_independent_audit_agent_eaa.py` | `d4b59c44f1b0f98b5cef98e5d48cfd12fae8f53d5097a506591c65e3703b6657` |
| `certificates/check_general_seed_orbit_nearest_gap_curator.py` | `scripts/check_general_seed_orbit_nearest_gap_curator.py` | `edb0cb236d22222e25fe201efb82a53eb4f85430ee447307946cfb67f9eaaea4` |
| `certificates/check_general_seed_orbit_nearest_gap_independent_audit_agent_gsa.py` | `scripts/check_general_seed_orbit_nearest_gap_independent_audit_agent_gsa.py` | `26548c2eb11cc08c41a542d39d47124c0ff45eff2f22f6c98344d599929179e5` |
| `certificates/check_uniform_local_clock_generalisation_agent_lcg.py` | `scripts/check_uniform_local_clock_generalisation_agent_lcg.py` | `cdf6992980c1ccffc9b88a9c82974eb8f59bb1a7080199fb3734a7abf536201e` |
| `magma/check_c0068_plus_j1_quartic_curator.m` | `scripts/check_c0068_plus_j1_quartic_curator.m` | `99685303f92c98364da5a59bf19be12145cb566d7af3c61ee2382e04bdd65a53` |
| `magma/check_j1_plus_branch_quartic_independent_audit_agent_j1.m` | `scripts/check_j1_plus_branch_quartic_independent_audit_agent_j1.m` | `13bc0efb9b017dba011d90b8d25a11ba620d9ad755dad7ec5126942fe2d880cc` |
| `magma/2026-08-23-c0068-plus-j1-quartic-curator.md` | `attempts/2026-08-23-c0068-plus-j1-quartic-curator.md` | `b033fbdb57d656af80a79c319d9f5c88555a4acabdd12130a045b4043ed6119b` |
| `magma/2026-08-23-j1-plus-branch-quartic-independent-audit-agent-j1.md` | `attempts/2026-08-23-j1-plus-branch-quartic-independent-audit-agent-j1.md` | `34dc6c928d049bc724ce413a7c33787ba9392896ee9a928d8634eabfd6d10e4e` |

The Python snapshots have no nonlocal runtime dependencies. Seven of the nine
new snapshots and every earlier snapshot import only the Python standard
library. The all-exponent source checker imports the vendored sibling
`check_c0082_full8_dp_closure_agent_c.py`, and the density checker imports the
vendored sibling `check_c0068_nearest_even_unit_gap_curator.py`. Both named
dependencies are included in this directory. No checker reads a nonlocal
auxiliary file. The Magma inputs are also self-contained. The Markdown audit
snapshots contain historical relative links to their original research-tree
neighbours; those links are provenance annotations and are not runtime
dependencies.
