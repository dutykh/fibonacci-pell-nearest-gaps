...
treated as given data, and \cref{eq:convergent-certificate} re-establishes by
...
\cref{eq:convergent-error-scaled}. The same certificate gives
...
The weakest certified interval occurs at $(\sigma,h)=(1,31)$, where
$\dist{Q\nu_{\sigma,h}}=0.01436\ldots$; it remains strictly above the
displayed margin. This is also the reason the sharper enclosure in
\cref{eq:convergent-certificate} is displayed: the Legendre bound alone
