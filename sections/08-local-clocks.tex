...
clocks. We now determine exactly which primes can synchronise in one of
...
in the cyclic interval $(m_0-\vartheta,m_0)$ with normalised Haar measure
...
\cref{lem:cross-gcd-factorisations}, gives, for every $a,b\geqslant1$,
