...
\begin{equation}
 \lambda^{h+3}<\frac{32}{5}\left(\frac{101}{100}\right)^2
...
and $1/5<u^2/5<16/5$. The constant before $A_3$ equals
$9.2747352540\ldots\mathbin{\cdot}10^{12}$ and therefore satisfies, with a
narrow margin, the exact outward inequality
