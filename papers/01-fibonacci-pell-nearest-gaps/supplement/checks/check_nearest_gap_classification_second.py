...
"""Second, independent exact checks for the all-exponent nearest-gap theorem.
...
continued-fraction argument checked separately.
"""
...
def main() -> None:
    ...
    print(
        "PASS: independent all-exponent exact check; parity selector, "
