...
"""Check for the section "Why the Fibonacci and Pell arms".
...
Run from the manuscript directory:
    ...
    python3 -B supplement/checks/check_two_arms.py
"""
...
def main() -> None:
    ...
    block_growth_rates()
    print(
        "PASS: two-arms check; Cohn normalisation, arm letter counts, branch "
