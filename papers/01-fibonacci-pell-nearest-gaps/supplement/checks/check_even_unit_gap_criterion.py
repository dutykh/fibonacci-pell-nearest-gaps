...
"""Exact checks for the nearest-gap criterion nearest-even-unit gap criterion.
...
* reconstructs every hit and verifies the anchored orbit orbit and determinant phase;
...
Run with:
    python3 -B supplement/checks/check_even_unit_gap_criterion.py
"""
...
def rectangle_delta(
    ...
    """Reconstruct the signed primitive factor rectangle and return its determinant."""
...
def direct_orbit_search(
    ...
    """Direct bounded the anchored orbit coefficient search for comparison."""
    pell_to_index = {
...
def main(q_bound: int = 2000) -> None:
    ...
    print(
        "PASS: the nearest-gap criterion nearest-even-unit gap; "
