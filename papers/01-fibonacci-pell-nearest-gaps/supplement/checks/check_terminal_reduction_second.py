...
"""Second, independent rational-interval computation for the the eight-term logarithmic form terminal reduction.
...
Run from the supplement directory:
    python3 -B supplement/checks/check_terminal_reduction_second.py
"""
...
def analytic_reduction_check() -> None:
...
def main() -> None:
    analytic_reduction_check()
    exact_terminal_enumeration()
    print(
        "PASS: independent the eight-term logarithmic form terminal check; q<10^32 cutoff checked; "
