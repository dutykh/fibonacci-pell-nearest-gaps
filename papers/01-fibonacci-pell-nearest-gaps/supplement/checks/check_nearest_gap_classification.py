...
trajectories.  It also reuses the already checked rational-interval engine
from to certify that its fixed and moving Dujella--Petho bounds are
...
import check_continued_fraction_closure as certified_dp
...
def certify_reused_dp_intervals() -> tuple[int, int]:
    """Rerun the checked fixed and moving rational-interval checks."""
