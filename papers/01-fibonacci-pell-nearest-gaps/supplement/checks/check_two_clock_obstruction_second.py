...
"""Second, independent exact checks for the imprimitive two-clock obstruction."""
...
def aligned_bins(
    ...
    """Return the two-clock recurrence two exact Fibonacci-companion index pairs."""
...
def main() -> None:
    """Run the second, independent exact checks."""

    check_rank_lifts()
    check_progression_algebra()
    check_finite_rows()
    print(
        "PASS: independent the two-clock recurrence imprimitive recurrence check; "
