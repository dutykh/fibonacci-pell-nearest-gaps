...
"""Exact local verification of the the nearest-gap criterion plus-branch j=1 quartics.
...
def main() -> None:
    ...
    print(
        "PASS: the nearest-gap criterion plus j=1 quartic; exact Magma point lists verified; "
