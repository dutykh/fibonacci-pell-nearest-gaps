...
"""Second, independent computation for the proposed two-sign odd-Pell theorem.
...
the universal result rests on the proof checked in the companion attempt.
"""
...
def check_boundaries() -> tuple[int, list[tuple[int, int]]]:
    ...
    # the normalized quotient specified by.
...
def main() -> None:
    ...
    print(
        "PASS: independent two-sign odd-Pell check; "
