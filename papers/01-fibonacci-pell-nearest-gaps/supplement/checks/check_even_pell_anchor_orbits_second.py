...
"""Second, independent computation for the even-Pell-anchor reduction.

This implementation deliberately does not import the first computation. It
...
def main() -> None:
    ...
    print(
        "PASS: second independent even-anchor computation; "
