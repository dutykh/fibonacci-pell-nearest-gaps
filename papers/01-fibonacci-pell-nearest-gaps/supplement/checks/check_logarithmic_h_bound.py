...
"""Exact constant checks for the the eight-term logarithmic form logarithmic h-bound attempt.
...
Dependencies: Python 3 standard library only. Deterministic command:
    python3 -B supplement/checks/check_logarithmic_h_bound.py
...
def main() -> None:
    ...
    print(
        "PASS: the eight-term logarithmic form logarithmic h-bound constants; "
