...
Mathematical target: reconstruct the eight-term logarithmic form eight terms in all four sign
...
Deterministic command from the supplement directory:
    python3 -B supplement/checks/check_adjusted_logarithmic_form.py
"""
...
def eight_terms(q: int, n: int, h: int, sigma: int, epsilon: int) -> list[MQ]:
    """Return the eight-term logarithmic form T_0,...,T_7 for M=n+h."""
    u_plus = sigma + R2 * PHI
...
def check_effective_cutoff() -> None:
    # The already checked Matveev prefactor from the Matveev specialization, excluding A_3.
    ...
    # Once q<10^32, the Matveev specialization gives this explicit h-box.
...
def main() -> None:
    ...
    print(
        "PASS: the eight-term logarithmic form full-eight adjusted form; four sign sectors and Galois "
        ...
        "conditional on the Matveev specialization and the archived Matveev specialization."
    )
