...
"""Second, independent integer computation for the general-seed orbit/gap theorem.

No project module or originating checker is imported.  The finite box is a
regression test only; the companion check supplies the universal proof.
"""
...
def main() -> None:
    ...
    print(
        "PASS: independent general-seed orbit/gap check; "
