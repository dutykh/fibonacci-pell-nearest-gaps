...
"""Second, independent computation for two proposed effective advances beyond the eight-term logarithmic form.

Questions checked
-----------------
   the two Galois permutations from exact arithmetic in
   Q(sqrt(2), sqrt(5)); independently enumerate all unordered 4+4 support
   partitions; impose the real-sign and the eight-term logarithmic form exceptional-partition filters;
...
Claim/attempt dependencies: the nearest-gap criterion, the eight-term logarithmic form and the two
...
Reproduce from the supplement directory with::

    python3 -B supplement/checks/check_effective_advances.py
...
def term_values(q: int, sigma: int, h: int, m: int) -> list[K]:
    """Evaluate the eight the eight-term logarithmic form terms exactly for a stress-test row."""
